...
export default async function Orders({ params, searchParams }) {
    ...
    return <>
        {(orders.statusMsg === 'fail' || orders.length === 0) ?
            <div className="min-h-[70vh] flex justify-center items-center flex-col gap-4">
                <p className="font-bold text-3xl">Make your first order now and get 40% off!</p>
                <Link href="/products" className={'text-white bg-linear-to-r from-indigo-700 to-purple-700 px-3 py-2 rounded-lg hover:from-indigo-800 hover:to-purple-800'}>Shop Now</Link>
            </div>
            : orders ?
