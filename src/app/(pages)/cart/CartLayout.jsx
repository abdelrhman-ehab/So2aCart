...
export default function CartLayout({ cartData, getCartDataError, updateCart, isUpdatingItem, removeFromCart, isRemovingItem, clearCart, clearingCartLoading, checkout, checkoutLoading }) {
                            ...
                            <Card key={product._id} className={'p-4 flex flex-row gap-4 rounded-lg'}>
                                ...
                                <div className='w-full shrink space-y-2'>
                                    ...
                                    <div className='flex items-center justify-between mt-3'>
                                        ...
                                        {isRemovingItem === product.product._id ? <Loader2 className='animate-spin' /> : <GoTrash className='text-2xl text-red-900 block sm:hidden' disabled={isRemovingItem === product.product._id} onClick={() => { removeFromCart(product.product._id) }} />}
                                    </div>
                                </div>
                            </Card>
                        )}
